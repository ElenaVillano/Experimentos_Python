...
# se hacen listas vacias solo con la primera cantidad de acuerdo a las preguntas que quieres ajustar la magnitud
set1=[200]
set2=[200]
set3=[200]
set4=[2000]
...
# se juntan una lista de listas de conjuntos
allSets =[set1,set2,set3,set4,set5,set6]

##### Alternatives       set1,set2,set3,set4,set5,set6
